...
import { showAddPlaceModalClose } from "../../slices/modalSlice.tsx";
...
function AddPlaceComponent() {
    ...
    const { isAddPlaceModalOpen } = modal;
    ...
    const onFormSubmit = (data: PlaceApi.PlaceProperty) => {
        ...
        dispatch(showAddPlaceModalClose());
    }
    ...
    return (
        <>
            ...
            />
            <Modal
                title="Tạo địa điểm quảng cáo"
                open={isAddPlaceModalOpen} // onOk={() => dispatch(showModalClose())}
                onCancel={() => {
                    dispatch(showAddPlaceModalClose());
            ...
            >
                ...
                >
                    ...
                    <Form.Item<PlaceApi.PlaceProperty> name={"ten_dia_diem"} label="Tên địa điểm"><Input /></Form.Item>
                    <Form.Item<PlaceApi.PlaceProperty> name={"dia_chi"} label="Địa chỉ"><Input /></Form.Item>
                    <Form.Item label="Vị trí">
                        <Input disabled className="w-5/6"
                            value={
                                place.placeLng != -1 && place.placeLat != -1
                                    ? `${place.placeLng} x ${place.placeLat}`
                                    : "Chọn vị trí"
                            } />{" "}
